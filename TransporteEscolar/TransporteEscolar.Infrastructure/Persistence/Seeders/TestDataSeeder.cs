...
public static class TestDataSeeder
{
    public static void SeedTestData(AppDbContext context)
    {
        ...
        {
            new Pasajero(titulares[0].Id, "Agustina Demo", "San Patricio", "4A", "Mañana", null, horarioPorEtiqueta["8 San Patricio"], fechaAltaSeeder),
            new Pasajero(titulares[1].Id, "Julián Demo", "Boisdron", "5B", "Mañana", null, horarioPorEtiqueta["8 Boisdron"], fechaAltaSeeder),
            new Pasajero(titulares[2].Id, "Victoria Demo", "San Patricio", "3C", "Tarde", "Requiere punto intermedio", horarioPorEtiqueta["12 San Patricio"], fechaAltaSeeder),
            new Pasajero(titulares[3].Id, "Mateo Demo", "Boisdron", "1A", "Tarde", null, horarioPorEtiqueta["16 San Patricio"], fechaAltaSeeder),
            new Pasajero(titulares[4].Id, "Lucía Demo", "San Patricio", "2A", "Mañana", null, null, fechaAltaSeeder)
        };
