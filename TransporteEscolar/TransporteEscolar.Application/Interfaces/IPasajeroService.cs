...
public interface IPasajeroService
{
    ...
    Task<PasajeroModel.Response> AgregarHorarioAsync(int pasajeroId, PasajeroHorarioModel.AsignacionRequest dto, CancellationToken cancellationToken = default);
    Task QuitarHorarioAsync(int pasajeroId, int horarioId, CancellationToken cancellationToken = default);
    Task QuitarHorarioPrincipalAsync(int pasajeroId, CancellationToken cancellationToken = default);
