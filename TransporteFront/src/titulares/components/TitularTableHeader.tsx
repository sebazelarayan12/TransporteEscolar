export const TitularTableHeader = () => {
  return (
    <div className="grid grid-cols-12 gap-4 px-6 py-4 border-b border-[#e4e4e7] dark:border-[#3f3f46] bg-gray-50 dark:bg-[#27272a] text-xs font-semibold text-gray-500 uppercase tracking-wider items-center sticky top-0 z-10">
