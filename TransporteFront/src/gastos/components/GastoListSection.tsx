...
export const GastoListSection = ({
  ...
  return (
    <section className="rounded-3xl border border-[#e1e8ec] bg-white p-5 shadow-sm dark:border-white/5 dark:bg-[#1f1f24]">
      <header className="flex flex-wrap items-end justify-between gap-4 border-b border-gray-100 pb-4 dark:border-white/5">
        <div>
