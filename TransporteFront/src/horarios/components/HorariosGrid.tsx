    ...
    <Card className="border border-gray-100/70 bg-white/95 shadow-none transition hover:ring-1 hover:ring-[#007a8a]/20 dark:border-white/5 dark:bg-[#1e1e23]">
      ...
      <CardContent className="p-0">
        <div className="border-t border-gray-100/80 p-4 dark:border-white/5 sm:p-5">
          ...
          <div className="mt-4 rounded-3xl border border-gray-100 bg-white/90 p-4 shadow-sm dark:border-white/5 dark:bg-[#1a1b21]/80 sm:p-6 md:flex md:flex-col md:rounded-2xl md:border-gray-100/70 md:bg-white md:shadow-lg dark:md:border-white/10 dark:md:bg-[#171821]">
            ...
            <div className="mt-6 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
              ...
              <button
                ...
                className={`flex w-full items-center justify-center rounded-full px-5 py-2 text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 md:self-end md:rounded-2xl md:px-4 md:py-1.5 md:text-xs ${transporteButtonClasses[activePanel.value]}`}
